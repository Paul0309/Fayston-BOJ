// ─── Problem bank keyed by division ───────────────────────────────────────────
// Each problem: { id, title, difficulty, tags, points, statement,
  ...
  Bronze: [
    {
      ...
      inputDesc: "A single line containing two integers A and B separated by a space. (−10⁹ ≤ A, B ≤ 10⁹)",
    ...
    },
    {
      ...
      inputDesc: "A single line with three integers a, b, c. (−10⁶ ≤ a, b, c ≤ 10⁶)",
  ...
  Silver: [
    {
      ...
      points: 100,
      statement: "Given an array of n integers and a query [l, r] (1-indexed), print the sum of elements from index l to r inclusive.",
  ...
  Gold: [
    {
      ...
      tags: ["dp", "math"],
      points: 100,
      statement: "Print the nth Fibonacci number, where fib(0) = 0, fib(1) = 1, and fib(n) = fib(n-1) + fib(n-2).",
    ...
    },
    {
      ...
      tags: ["string", "greedy"],
      points: 100,
      statement: "Given a line of space-separated words, print the longest word. If there is a tie, print the first one.",
      inputDesc: "One line with space-separated words (each word has only lowercase letters).",
  ...
  Platinum: [
    {
      ...
      inputDesc: "One string s (1 ≤ |s| ≤ 1000, only lowercase letters).",
    ...
    },
    {
      ...
      points: 100,
      statement: "Given an n × n matrix, compute the sum of its main diagonal (top-left to bottom-right).",
    ...
    },
    {
      ...
      points: 100,
      statement: "Given a lowercase string, print the frequency of each character that appears, in alphabetical order, formatted as c:count pairs separated by spaces.",
