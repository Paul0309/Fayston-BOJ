...
export default async function AdminPage() {
    ...
    const [allowedLanguages, monitor] = await Promise.all([
        getAllowedLanguages(),
        getAdminMonitorSnapshot()
    ]);
            ...
            <main className="flex-1 lg:ml-64 py-8 px-4 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-1 text-sm text-neutral-400">시스템 상태와 문제를 관리합니다.</p>
                    </div>

                    {/* Monitoring Section */}
                    <section id="monitoring" className="mb-8">
                        <h2 className="text-lg font-bold text-neutral-100 mb-4">시스템 상태</h2>
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                            <MetricsCard label="대기 큐" value={monitor.queue.pending} />
